...
function Sidebar(props) {
    ...
    const [bulkMessageMenuAnchorEl, setBulkMessageMenuAnchorEl] =
        useState(null);
                ...
                Object.entries(data).forEach((message) => {
                    ...
                    if (
                        ...
                        if (props.newMessages[chatMessageWaId] === undefined) {
                            preparedNewMessages[chatMessageWaId] =
                                new NewMessageClass(chatMessageWaId, 0);
                        }
            ...
            (response) => {
                ...
                if (willNotify) {
                    ...
                    props.setNewMessages((prevState) => {
                        Object.entries(preparedNewMessages).forEach(
                            (newMsg) => {
                        ...
                        if (
                            JSON.stringify(preparedNewMessages) !==
        ...
        <div className={'sidebar' + (props.isChatOnly ? ' hidden' : '')}>
            ...
            <div className="sidebar__results" ref={chatsContainer}>
                ...
                {(keyword.trim().length > 0 ||
                    props.isSelectionModeEnabled) && <h3>Chats</h3>}
