                            ...
                            0 /*&& waId !== props.chatData.waId*/ ? (
                                ...
                                <div className="sidebarChat__info__lastMessage__body">
                                    <ChatMessageShortContent
                                        ...
                                        buttonText={
                                            props.chatData.lastMessageButtonText
                                        }
                                        interactiveButtonText={
                                            props.chatData.interactiveButtonText
                                        }
                                        text={props.chatData.lastMessageBody}
                                        caption={
                                            props.chatData.lastMessageCaption
                                        }
                                        isLastMessageFromUs={
                                            props.chatData.isLastMessageFromUs
                                        }
                                    />
                                </div>
                            )}
