...
function Contacts(props) {
    ...
    const [isPhoneNumberFormVisible, setPhoneNumberFormVisible] =
        useState(false);
        ...
        <div className="contacts">
            ...
            <div className="contacts__startByPhoneNumberWrapper">
                <div
                    ...
                    onClick={() =>
                        setPhoneNumberFormVisible((prevState) => !prevState)
                    }
                >
                    <ListItem button>
                ...
                {isPhoneNumberFormVisible && (
                    <div className="contacts__startByPhoneNumberWrapper__formWrapper">
                        ...
                        <Button
                            color="primary"
                            onClick={() =>
                                verifyContact(undefined, phoneNumber)
                            }
                        >
                            {t('Start')}
                        </Button>
            ...
            <div className="contacts__body">
                {getObjLength(persons) > 0 && (
                    <div className="contacts__body__headerWrapper">
                        ...
                        <IconButton
                            onClick={() =>
                                setPersonsVisible((prevState) => !prevState)
                            }
                        >
                ...
                {getObjLength(contacts) > 0 && (
                    <div className="contacts__body__headerWrapper">
                        ...
                        <IconButton
                            onClick={() =>
                                setContactsVisible((prevState) => !prevState)
                            }
                        >
                            {isContactsVisible ? (
                                <ExpandLess />
